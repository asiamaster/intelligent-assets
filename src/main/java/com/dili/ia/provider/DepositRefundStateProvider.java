...
import com.dili.ia.glossary.DepositPayStateEnum;
 ...
 */
@Component
public class DepositRefundStateProvider implements ValueProvider {

    private static final List<ValuePair<?>> BUFFER = new ArrayList<>();

    static {
        BUFFER.addAll(Stream.of(DepositRefundStateEnum.values())
