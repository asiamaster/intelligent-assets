...
import com.dili.ia.glossary.CarDepartmentEnum;
 ...
 */
@Component
public class CarDepartmentProvider implements ValueProvider {
    private static final List<ValuePair<?>> BUFFER = new ArrayList<>();

    static {
        BUFFER.addAll(Stream.of(CarDepartmentEnum.values())
