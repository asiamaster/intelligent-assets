...
public class DepositOrderServiceImpl extends BaseServiceImpl<DepositOrder, Long> implements DepositOrderService {
     ...
     */
    @Override
    public CustomerExtendDto checkCustomerState(Long customerId,Long marketId){
    ...
    private SettleOrderDto buildSettleOrderDto(UserTicket userTicket,DepositOrder depositOrder, PaymentOrder paymentOrder, Long paidAmount){
        ...
        List<BusinessChargeItemDto> chargeItemDtos = businessChargeItemService.queryFixedBusinessChargeItemConfig(depositOrder.getMarketId(), BizTypeEnum.DEPOSIT_ORDER.getCode(), YesOrNoEnum.YES.getCode(), YesOrNoEnum.YES.getCode(), BizTypeEnum.DEPOSIT_ORDER.getEnName());
